...
def process_product_names(row, model, product_embeddings_file_obj1):
    ...
    input_text = (
        f"productName: {productName_cleaned} {subCategory1_cleaned} {subCategory2_cleaned}. " 
        f"brandName: {brandName_cleaned} {brandName_cleaned} {brandName_cleaned}. " 
    )
    ...
    # print("product_embedding_list1", product_embedding_list)
    del (
        productName_cleaned,
        mainCategory_cleaned,
        subCategory1_cleaned,
