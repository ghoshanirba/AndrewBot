...
def process_product(
    ...
    user_reuest_productName_embedding_array = np.array(productName_embedding).reshape(
        1, -1
    )
    ...
    user_reuest_brandName_embedding_array = np.array(brandName_embedding).reshape(1, -1)
    ...
    for index, embedding in product_embeddings_df.iterrows():
        ...
        product_name_similarity = cosine_similarity(
            user_reuest_productName_embedding_array, productName_embedding_array
        )[0][0]

        brand_name_similarity = cosine_similarity(
            user_reuest_brandName_embedding_array, brandName_embedding_array
        )[0][0]
