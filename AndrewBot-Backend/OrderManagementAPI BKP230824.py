...
def process_product(
    ...
    # input_text_product = (
    #     f"The name of the product is {user_request_product_name_cleaned}. "
    #     f"It belongs to the brand {best_matched_brand_name_cleaned}. "
    #     f"{user_request_product_name_cleaned} is known for its high quality and is a popular product by {best_matched_brand_name_cleaned}."
    # )
...
def find_top_matched_product_ID(
    ...
    correlation, _ = pearsonr(user_request_product_embedding_array, all_product_embeddings)
