...
export default function ViewOrderPage() {
  ...
  function getShippingAddressTooltip(): string | undefined {
    ...
    const addressLines = [
      orderDetails.shippingAdress.houseNumber,
      orderDetails.shippingAdress.buildingName,
      orderDetails.shippingAdress.street,
      orderDetails.shippingAdress.addressLine1,
      orderDetails.shippingAdress.addressLine2,
      orderDetails.shippingAdress.addressLine3,
      `${orderDetails.shippingAdress.city}, ${orderDetails.shippingAdress.state}`,
      `PIN - ${orderDetails.shippingAdress.pincode}`,
      orderDetails.shippingAdress.landMark,
            ...
            <tbody>
              {orderDetails?.items.map((item, index) => (
                <tr className="table table-striped" key={index}>
                  ...
                  <td className="table-data-font">{item.productName}</td>
                  <td className="table-data-font">{item.productBrand}</td>
                  <td className="table-data-font">{item.productWeight}</td>
                  <td className="table-data-font">{item.productQty}</td>
                  <td className="table-data-font">
                    Rs. {item.unitPriceMRP.toFixed(2)}
                  </td>
                  <td className="table-data-font">
                    Rs. {item.totalPriceMRP.toFixed(2)}
                  </td>
                  <td className="table-data-font">
